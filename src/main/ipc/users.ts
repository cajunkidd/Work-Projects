...
export function registerUserHandlers(): void {
  ...
  ipcMain.handle(
    ...
    async (
      _e,
      payload: { name: string; email: string; password: string; role: string; department_ids: number[]; branch_ids: number[] }
  ...
  ipcMain.handle(
    ...
    async (
      _e,
      payload: { id: number; name?: string; role?: string; department_ids?: number[]; branch_ids?: number[]; password?: string }
