 ...
 * Only runs if no contracts exist yet (to avoid duplicating data).
 * Call removeDemoData() to clean up afterward.
 */
export async function seedDemoData(): Promise<void> {
  ...
  const departments = ['Information Technology', 'Operations', 'Marketing', 'Human Resources', 'Finance']
  ...
  userInsert.run('Sarah Mitchell', 'sarah@demo.com', hash, 'director', JSON.stringify([deptMap['Information Technology'], deptMap['Operations']]), JSON.stringify(branchRows.slice(0, 5).map((b) => b.id)))
  userInsert.run('James Cooper', 'james@demo.com', hash, 'store_manager', '[]', JSON.stringify([branchRows[0]?.id]))
  ...
  const contracts = [
    // IT contracts
    { vendor: 'Microsoft', status: 'active', start: '2025-07-01', end: '2027-06-30', monthly: 18500, poc: 'Lisa Chen', email: 'lisa.chen@microsoft.com', phone: '(425) 555-0142', dept: 'Information Technology', branch: null },
    { vendor: 'Cisco Systems', status: 'active', start: '2025-01-15', end: '2027-01-14', monthly: 12800, poc: 'Robert Hayes', email: 'rhayes@cisco.com', phone: '(408) 555-0198', dept: 'Information Technology', branch: null },
    { vendor: 'CrowdStrike', status: 'active', start: '2025-09-01', end: '2026-08-31', monthly: 8400, poc: 'Amanda Torres', email: 'atorres@crowdstrike.com', phone: '(512) 555-0167', dept: 'Information Technology', branch: null },
    { vendor: 'Salesforce', status: 'expiring_soon', start: '2024-05-01', end: '2026-04-30', monthly: 15200, poc: 'Kevin Wright', email: 'kwright@salesforce.com', phone: '(415) 555-0133', dept: 'Operations', branch: null },
    { vendor: 'Adobe Creative Cloud', status: 'active', start: '2025-03-01', end: '2027-02-28', monthly: 4800, poc: 'Diana Patel', email: 'dpatel@adobe.com', phone: '(408) 555-0211', dept: 'Marketing', branch: null },
    { vendor: 'ADP Workforce Now', status: 'active', start: '2025-06-01', end: '2027-05-31', monthly: 9600, poc: 'Marcus Johnson', email: 'mjohnson@adp.com', phone: '(973) 555-0188', dept: 'Human Resources', branch: null },
    { vendor: 'Oracle NetSuite', status: 'expiring_soon', start: '2024-08-01', end: '2026-05-15', monthly: 22000, poc: 'Rachel Kim', email: 'rkim@oracle.com', phone: '(650) 555-0155', dept: 'Finance', branch: null },
    { vendor: 'ServiceNow', status: 'active', start: '2025-10-01', end: '2027-09-30', monthly: 11500, poc: 'Thomas Baker', email: 'tbaker@servicenow.com', phone: '(669) 555-0177', dept: 'Information Technology', branch: null },
    { vendor: 'Zoom Communications', status: 'active', start: '2026-01-01', end: '2027-12-31', monthly: 3200, poc: 'Emily Nguyen', email: 'enguyen@zoom.us', phone: '(888) 555-0144', dept: 'Operations', branch: null },
    { vendor: 'AWS Cloud Services', status: 'active', start: '2025-04-01', end: '2028-03-31', monthly: 34000, poc: 'David Park', email: 'dpark@amazon.com', phone: '(206) 555-0199', dept: 'Information Technology', branch: null },
    // Branch-level contracts
    { vendor: 'Xerox Copier Lease', status: 'active', start: '2025-08-01', end: '2027-07-31', monthly: 850, poc: 'Janet Hill', email: 'jhill@xerox.com', phone: '(585) 555-0122', dept: null, branch: 0 },
    { vendor: 'ADT Security', status: 'expiring_soon', start: '2024-06-01', end: '2026-05-31', monthly: 1200, poc: 'Brian Scott', email: 'bscott@adt.com', phone: '(561) 555-0166', dept: null, branch: 1 },
    { vendor: 'Cintas Uniforms', status: 'active', start: '2025-11-01', end: '2027-10-31', monthly: 680, poc: 'Laura Adams', email: 'ladams@cintas.com', phone: '(513) 555-0188', dept: null, branch: 2 },
    { vendor: 'Waste Management', status: 'active', start: '2025-02-01', end: '2027-01-31', monthly: 475, poc: 'Greg Turner', email: 'gturner@wm.com', phone: '(713) 555-0133', dept: null, branch: 3 },
    { vendor: 'FedEx Shipping', status: 'pending', start: '2026-04-01', end: '2028-03-31', monthly: 2100, poc: 'Nicole Brown', email: 'nbrown@fedex.com', phone: '(901) 555-0177', dept: 'Operations', branch: null },
    { vendor: 'Comcast Business', status: 'expired', start: '2023-06-01', end: '2025-05-31', monthly: 1600, poc: 'Chris Davis', email: 'cdavis@comcast.com', phone: '(215) 555-0155', dept: 'Information Technology', branch: null },
  ]

  const contractIds: number[] = []
  contracts.forEach((c) => {
    const annual = c.monthly * 12
    const months = Math.round((new Date(c.end).getTime() - new Date(c.start).getTime()) / (1000 * 60 * 60 * 24 * 30))
    ...
    const result = contractInsert.run(c.vendor, c.status, c.start, c.end, c.monthly, annual, total, c.poc, c.email, c.phone, deptId, branchId)
  ...
  // Cisco allocated to IT dept fully
  ...
  const invoices = [
    { cIdx: 0, subject: 'Microsoft 365 - March 2026 Invoice', sender: 'billing@microsoft.com', amount: 18500, budgeted: 18500, date: '2026-03-01' },
    { cIdx: 0, subject: 'Microsoft 365 - February 2026 Invoice', sender: 'billing@microsoft.com', amount: 18500, budgeted: 18500, date: '2026-02-01' },
    { cIdx: 9, subject: 'AWS Monthly Invoice - March 2026', sender: 'aws-billing@amazon.com', amount: 36200, budgeted: 34000, date: '2026-03-05' },
    { cIdx: 1, subject: 'Cisco Meraki License Renewal Q1', sender: 'invoices@cisco.com', amount: 12800, budgeted: 12800, date: '2026-03-10' },
    { cIdx: 3, subject: 'Salesforce CRM - March 2026', sender: 'billing@salesforce.com', amount: 15200, budgeted: 15200, date: '2026-03-02' },
    { cIdx: 5, subject: 'ADP Payroll Services - March', sender: 'billing@adp.com', amount: 9600, budgeted: 9600, date: '2026-03-01' },
    { cIdx: 6, subject: 'Oracle NetSuite - March 2026', sender: 'ar@oracle.com', amount: 22000, budgeted: 22000, date: '2026-03-08' },
    { cIdx: 9, subject: 'AWS Monthly Invoice - February 2026', sender: 'aws-billing@amazon.com', amount: 33100, budgeted: 34000, date: '2026-02-05' },
    { cIdx: 2, subject: 'CrowdStrike Falcon - Q1 2026', sender: 'billing@crowdstrike.com', amount: 25200, budgeted: 25200, date: '2026-01-15' },
    { cIdx: 4, subject: 'Adobe CC Team - March 2026', sender: 'billing@adobe.com', amount: 4800, budgeted: 4800, date: '2026-03-01' },
  ]
  invoices.forEach((inv) => {
    invInsert.run(contractIds[inv.cIdx], `demo-${Date.now()}-${Math.random().toString(36).slice(2, 8)}`, inv.subject, inv.sender, inv.amount, inv.budgeted, inv.date)
  })
